...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Lambada Digital');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@mail.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
